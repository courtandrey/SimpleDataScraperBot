...
public class GapphParser {
    public List<RentalOffering> parsePage(String docToParse) {
        ...
        for (Element rental : rentals) {
            ...
            rentalOffering.setCity(textFromElements(rental.getElementsByTag("h2")));
            rentalOffering.setPrice(textFromElements(rental.getElementsByClass("ribbon")));
            rentalOffering.setUrl("https://www.gapph.nl/" + rental.getElementsByAttribute("href").attr("href"));
