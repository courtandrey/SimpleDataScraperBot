...
public class RotterdamWonenParser {
    public List<RentalOffering> parsePage(String docToParse) {
        Document document = Jsoup.parse(docToParse);
        Elements rentals = document.getElementsByClass("property-list-item");
        List<RentalOffering> offerings = new ArrayList<>();
        for (Element rental : rentals) {
            RentalOffering rentalOffering = new RentalOffering();
            rentalOffering.setName(rental.getElementsByClass("property-list-title").text());
            rentalOffering.setCity("Rotterdam");
            rentalOffering.setPrice(rental.attr("data-price"));
            rentalOffering.setUrl(rental.attr("data-link"));
