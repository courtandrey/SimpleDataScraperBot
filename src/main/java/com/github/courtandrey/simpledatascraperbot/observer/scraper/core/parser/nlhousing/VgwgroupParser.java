...
public class VgwgroupParser {
    public List<RentalOffering> parsePage(String docToParse) {
        ...
        for (Element rental : rentals) {
            ...
            rentalOffering.setCity(textFromElements(rental.getElementsByClass("locality")));
            ...
            rentalOffering.setUrl("https://www.vgwgroup.nl" + rental.getElementsByAttribute("href").attr("href"));
