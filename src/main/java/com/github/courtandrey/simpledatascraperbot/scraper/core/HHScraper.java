...
public class HHScraper extends VacancyScraper {
    public HHScraper() {
        ...
        urls = new String[]{
                ...
                "https://hh.ru/search/vacancy?schedule=remote&search_field=name&search_field=company_name&search_field=description&text=Промышленный+язык+программирования&from=suggest_post&page=1&hhtmFrom=vacancy_search_list0",
                "https://hh.ru/search/vacancy?schedule=remote&search_field=name&search_field=company_name&search_field=description&text=Дата+аналитик&from=suggest_post&page=1&hhtmFrom=vacancy_search_list0"
        };
        startPageNum = 0;
    }
