...
@Slf4j
public class StopAdminCommand extends BaseCommand {
    @Autowired
    private UserService userService;

    public StopAdminCommand() {
        super("stopAdmin", "Stop any process");
    }
    ...
    private void showMessage(AbsSender absSender, Long chatId) {
        sendAnswer(
                absSender,
                "Type id of user. If you don't know id of user, you can check running processes for user with /showAllProcesses command",
                chatId
        );
    }
}
